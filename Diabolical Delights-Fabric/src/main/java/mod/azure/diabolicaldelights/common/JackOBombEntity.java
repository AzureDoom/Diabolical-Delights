...
public class JackOBombEntity extends AbstractArrow implements GeoEntity {
	...
	public JackOBombEntity(Level world, LivingEntity owner) {
		super(ModProjectiles.JACKOBOMB_ENTITY, owner, world);
	}
	...
	public JackOBombEntity(Level world, double x, double y, double z, ItemStack stack) {
		super(ModProjectiles.JACKOBOMB_ENTITY, world);
	...
	public JackOBombEntity(Level world, double x, double y, double z) {
		super(ModProjectiles.JACKOBOMB_ENTITY, x, y, z, world);
	...
	public void summonAoE(Entity entity, ParticleOptions particle, int yOffset, int duration, float radius, int effectTime) {
		...
		var effects = Arrays.asList(MobEffects.MOVEMENT_SPEED, MobEffects.MOVEMENT_SLOWDOWN, MobEffects.DIG_SPEED, MobEffects.DIG_SLOWDOWN, MobEffects.DAMAGE_BOOST, MobEffects.HEAL, MobEffects.HARM, MobEffects.JUMP, MobEffects.CONFUSION, MobEffects.REGENERATION, MobEffects.DAMAGE_RESISTANCE, MobEffects.FIRE_RESISTANCE, MobEffects.WATER_BREATHING, MobEffects.INVISIBILITY, MobEffects.BLINDNESS, MobEffects.NIGHT_VISION, MobEffects.HUNGER, MobEffects.WEAKNESS, MobEffects.POISON, MobEffects.WITHER,
				MobEffects.HEALTH_BOOST, MobEffects.ABSORPTION, MobEffects.SATURATION, MobEffects.GLOWING, MobEffects.LEVITATION, MobEffects.LUCK, MobEffects.UNLUCK, MobEffects.SLOW_FALLING, MobEffects.CONDUIT_POWER, MobEffects.DOLPHINS_GRACE, MobEffects.BAD_OMEN, MobEffects.HERO_OF_THE_VILLAGE, MobEffects.DARKNESS);
		areaEffectCloudEntity.addEffect(new MobEffectInstance(effects.get(this.random.nextInt(effects.size())), effectTime, 0));
		this.playSound(ModSounds.JACKOBOMB_SOUND, 0.5f, 1.0f);
